...
- **Atenção — só visual (correção de 2026-09-26):** nesta leva a copy foi transplantada **literalmente** do HTML antigo para o shell novo; nenhum texto foi revisado contra a voz do Sharebook e todos continuavam saudando com `{User.Name}` cru (nome completo, às vezes em caixa alta). "Concluído" aqui significa layout, não e-mail pronto. A revisão de copy desta leva virou item próprio: [`revisao-copy-emails-leva-2.md`](revisao-copy-emails-leva-2.md) (concluída em 2026-09-26).
