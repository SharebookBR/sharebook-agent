...
9. **[Home v2 — mais baixados e vitrines temáticas](todo/home-v2-curadoria-ranking.md)** — valor médio, esforço médio. Próxima fatia aprovada: prateleira "Mais baixados nos últimos 30 dias" com `BookDownloadEvent`, `UserId` opcional via JWT, backfill GA4 e cache SSR preservado.
