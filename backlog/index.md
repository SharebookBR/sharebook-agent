...
Revisada em **2026-08-22**, considerando valor atual para produto/operação e esforço relativo.

1. **[Bugs de API, filtros e rotas](backlog/todo/maior-site-livros/_plano.md#-tech-debt--bugs-priorizar)** — alto valor, esforço baixo–médio. Corrigir Category PUT, filtros de Book, rota ambígua e identidade operacional do importer.
2. **[Limpeza de Duplicatas no Catálogo](backlog/todo/limpeza-duplicatas-catalogo.md)** — alto valor, esforço médio. Melhora busca, SEO e analytics e prepara o catálogo para embeddings.
3. **[SEO v1](backlog/todo/seo-v1/_plano.md)** — alto valor, esforço baixo–médio. Atacar CTR, metadados curtos e schema completo nas PDPs.
4. **[Busca textual: FTS + fuzzy](backlog/todo/busca-e-recomendacao-sharebook.md)** — alto valor, esforço médio. Centralizar disponibilidade e melhorar relevância antes de introduzir vetores.
5. **[Painel de Jobs](backlog/todo/painel-de-jobs.md)** — alto valor, esforço médio. Tornar falhas, atrasos e fluxo de filas visíveis e acionáveis.
6. **[Expansão curada do acervo](backlog/todo/maior-site-livros/_plano.md)** — alto valor, esforço médio contínuo. Priorizar fontes simples e editoriais antes das fontes incertas:
...
7. **[Dependências e Segurança](backlog/todo/seguranca-e-vulnerabilidades.md)** — alto valor, alto esforço. Modernizar incrementalmente, sem salto cego de major.
