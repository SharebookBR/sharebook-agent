#!/usr/bin/env python3
"""Debug query - run SQL via SSH heredoc and print full stderr."""
import sys
...
# Build the remote command using cat heredoc approach
remote_cmd = (
...
# Use exec_command with the full command as a single string
