# Família de Skills — Produto e UX

Conhecimento de produto, voz, interface, layout, catálogo visível e experiência do usuário.

## Skills
- `./voice-glossary/SKILL.md` — Voz oficial, sinopses e glossário.
- `./ux-reviewer/SKILL.md` — Auditoria de UX, fluxos e interface.
