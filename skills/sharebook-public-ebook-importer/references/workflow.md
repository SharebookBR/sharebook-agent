...
3. Definir capa com foco em custo/qualidade: reutilizar capa existente quando adequada; se não houver opção boa/segura, gerar capa autoral com `codex-scripts/sharebook_openai_cover.py --prompt-file` (prompt em UTF-8).
...
- Tratar a capa como ativo de conversão do Sharebook.
