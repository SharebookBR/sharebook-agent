...
# 3. Buscar livros da categoria Artes (paginação)
all_books = []
page = 1
while True:
    r = requests.get(f'{base}/Book', params={'categoryId': artes['id'], 'page': page, 'itemsPerPage': 100}, headers=headers)
    if r.status_code != 200:
...
print(f"\nTotal de livros na categoria Artes: {len(all_books)}")
